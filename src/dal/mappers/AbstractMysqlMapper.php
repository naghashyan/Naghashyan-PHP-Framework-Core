...
namespace ngs\dal\mappers {
  ...
  abstract class AbstractMysqlMapper extends AbstractMapper {
    ...
    public function insertDtos($dtos) {
      ...
      $sqlQuery = sprintf('INSERT INTO `%s` (', $this->getTableName());

      $dto_fields = array_values($dtos[0]->getMapArray());
      $dbFields = array_keys($dtos[0]->getMapArray());
